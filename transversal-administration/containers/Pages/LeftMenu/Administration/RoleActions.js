...
class RoleActions extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      commercial_typeOfAction_access: false,
      commercial_typeOfAction_create: false,
      commercial_typeOfAction_modify: false,
      commercial_typeOfAction_delete: false,
      commercial_typeOfAction_export: false,
  ...
  componentDidMount() {
    const {
      getAllRoles, getAllActions, location
    } = this.props;
    getAllRoles();
    getAllActions();
  ...
  handleSubmit = () => {
    ...
    const {
      ...
      commercial_typeOfAction_access,
      commercial_typeOfAction_create,
      commercial_typeOfAction_modify,
      commercial_typeOfAction_delete,
      commercial_typeOfAction_export,
  ...
  render() {
    ...
    const {
      classes, allRoles, addRole, errors, isLoading, roleResponse, getAllRoles, updateRole, deleteRole, allActions, addRoleAbilities,
          ...
          <Accordion expanded={expanded === 'panel2'} onChange={this.handleChangePanel('panel2')}>
            ...
            <AccordionDetails>
              ...
              <FormControl component="fieldset" className={classes.formControl}>
                <FormGroup>
                  <FormControlLabel
                      control={<Checkbox checked={commercial_typeOfAction_access} onChange={this.handleChange} name="commercial_typeOfAction_access" />}
                      label="Access"
                  />
                  <FormControlLabel
                      control={<Checkbox checked={commercial_typeOfAction_create} onChange={this.handleChange} name="commercial_typeOfAction_create" />}
                      label="Create"
                  />
                  <FormControlLabel
                      control={<Checkbox checked={commercial_typeOfAction_modify} onChange={this.handleChange} name="commercial_typeOfAction_modify" />}
                      label="Modify"
                  />
                  <FormControlLabel
                      control={<Checkbox checked={commercial_typeOfAction_delete} onChange={this.handleChange} name="commercial_typeOfAction_delete" />}
                      label="Delete"
                  />
                  <FormControlLabel
                      control={<Checkbox checked={commercial_typeOfAction_export} onChange={this.handleChange} name="commercial_typeOfAction_export" />}
                      label="Export"
                  />
                </FormGroup>
              </FormControl>
