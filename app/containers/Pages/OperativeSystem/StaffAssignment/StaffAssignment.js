...
class StaffAssignment extends React.Component {
  ...
  render() {
    const {
      location, classes, intl, treeData, isLoading, staffAssignmentResponse, errors, assignedStaff, eligibleStaff, updateOperationAssignment, getStaffAssignedByOperation, logedUser,getEligibleStaff
    } = this.props;
        ...
        {this.state.open
          ? (
            <AssignStaff
              ...
              getEligibleStaff = {getEligibleStaff}
              errors={errors}
